...
# generates world table at startup
end = "!"
c1 = end
c2 = end
table = {}
...
def genword():
    ...
    while True:
        ...
        if c != end:
            ...
            # not supported
            #c1, c2 = random_choice(table.keys())
            t = random_choice(table.keys())
            c1 = t[0]
            c2 = t[1]
    ...
    if len(word) > 10:
        word = word[:10]
    return word #+ str(random.randint(0,100))
...
if __name__ == "__main__":
    ...
    print
    print c, "collisions per", N, "words"
    print "Collision words:",ws.join("")
