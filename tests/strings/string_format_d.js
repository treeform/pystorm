...
// generated by py2js from tests/strings/string_format_d.py
...
s=py2js_mod_format('b=%d',b);
console.log(String(s));

s=py2js_mod_format('b,c,d=%d+%d+%d',[b,c,d]);
console.log(String(s));

s=py2js_mod_format('b=%(b)0d and c=%(c)d and d=%(d)d',{'b':b,'c':c,'d':d});
console.log(String(s));

s=py2js_mod_format('e=%020d e=%+d e=%20d e=%-20d (e=%- 20d)',[e,e,e,e,e]);
console.log(String(s));
