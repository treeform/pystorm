...
// generated by py2js from tests/strings/string_format_efg.py
...
container_py2js_1=codes;
var generator_py2js_2 = new Generator(container_py2js_1);
for(code=generator_py2js_2.nextValue();generator_py2js_2.hadMore();code=generator_py2js_2.nextValue()) {
    
    
    container_py2js_3=fmts;
    var generator_py2js_4 = new Generator(container_py2js_3);
    for(fmt=generator_py2js_4.nextValue();generator_py2js_4.hadMore();fmt=generator_py2js_4.nextValue()) {
        
        fmt=py2js_replace(fmt,'e',code);
        
        
        container_py2js_5=vars;
        ...
        for(v=generator_py2js_6.nextValue();generator_py2js_6.hadMore();v=generator_py2js_6.nextValue()) {
            console.log(String((fmt + ':'))+ " " +String((py2js_mod_format(fmt,v))));
        }
    }
}
