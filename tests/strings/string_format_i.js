...
// generated by py2js from tests/strings/string_format_i.py
...
s=py2js_mod_format('b=%i',b);
console.log(String(s));

s=py2js_mod_format('b,c,d=%i+%i+%i',[b,c,d]);
console.log(String(s));

s=py2js_mod_format('b=%(b)i and c=%(c)i and d=%(d)i',{'b':b,'c':c,'d':d});
console.log(String(s));

s=py2js_mod_format('e=%020i e=%+i e=%20i e=%-20i (e=%- 20i)',[e,e,e,e,e]);
console.log(String(s));
