...
// generated by py2js from tests/strings/string_format_o.py
...
for(val=generator_py2js_2.nextValue();generator_py2js_2.hadMore();val=generator_py2js_2.nextValue()) {
    ...
    for(fmt=generator_py2js_4.nextValue();generator_py2js_4.hadMore();fmt=generator_py2js_4.nextValue()) {
        console.log(String((fmt + ':'))+ " " +String((py2js_mod_format(fmt,val))));
    }
}
