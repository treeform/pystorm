...
// generated by py2js from tests/strings/string_format_u.py
...
s=py2js_mod_format('b=%u',b);
console.log(String(s));

s=py2js_mod_format('b,c,d=%u+%u+%u',[b,c,d]);
console.log(String(s));

s=py2js_mod_format('b=%(b)0u and c=%(c)u and d=%(d)u',{'b':b,'c':c,'d':d});
console.log(String(s));

s=py2js_mod_format('e=%020u e=%+u e=%20u e=%-20u (e=%- 20u)',[e,e,e,e,e]);
console.log(String(s));
